...
import { createMonconReport, getMonconReports, getNoticesByReportId } from '../../services/monconServices'
          ...
          {generalData.map((data, index) => (
            <TableRow key={index}>
              ...
              <TableCell className="flex flex-row gap-2">
                ...
                <Button size="sm" onClick={() => { setRegisterSelected(data); setOpenViewRegister(true) }}><FaEye /> </Button>
